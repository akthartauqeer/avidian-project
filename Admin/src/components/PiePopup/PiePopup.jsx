...
const PieGraph = ({ queryResult, representationName, handleNameChange, color, setColors,handleColorChange,    valueColumn,labelColumn,setLabelColumn,setValueColumn,selectedRepresentation,setRepresentationName
}) => {
    ...
    const handlePieGraphSubmit = () => {
        if (!labelColumn || !valueColumn) {
            setError('Please select both label (X-axis) and value (Y-axis) columns.');
        } else {
            setError('');
        }
    };
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh' }}>
            ...
            <label style={{ marginBottom: '20px' }}>
                ...
                <input
                    ...
                    placeholder="Enter a title for your pie chart"
